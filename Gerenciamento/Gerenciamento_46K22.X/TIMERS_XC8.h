...
#define nINT_CCP1     PIE1bits.CCP1IE  //<<<<<<<*****************************************************
...
#define nFLAG_CCP1          PIR1bits.CCP1IF  //<<<<<<<*****************************************************
...
#define __Interrupt_CCP1__      if(PIR1bits.CCP1IF && PIE1bits.CCP1IE) //<<<<<<<*****************************************************
